    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/MzoneMovieMl"),
                    InlineKeyboardButton("Support Group", url="https://t.me/Mzonechat")
                ]
            ]
        )
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/joinchat/GaCZ_Z_9P-xhYWQx")
                ],
                [
